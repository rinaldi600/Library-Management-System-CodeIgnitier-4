        ...
        <?php if (count($users) <= 0) { ?>
            <td colspan="9">
                <div class="alert alert-danger" role="alert">
                    Data Not Found <a href="/dashboardAdmin/pendingRequest">Back</a>
                </div>
            </td>
        <?php } ?>
            ...
            <tr>
                ...
                <td class="d-flex gap-3">
                    <form action="/dashboardAdmin/acceptRequest" method="post">
                        ...
                        <button class="btn btn-success" type="submit" onclick="return confirm('Do you sure accept book ?')">Accept</button>
                    </form>
                    <form action="/dashboardAdmin/declineUser" method="post">
                        <input type="hidden" value="<?= $rent["idRent"] ?>" name="getIdRent">
                        <button class="btn btn-warning" type="submit">Decline</button>
                    </form>
                    <form action="/dashboardAdmin/deleteRequest" method="post">
                        <input type="hidden" value="<?= $rent["idRent"] ?>" name="getIdRent">
                        <button class="btn btn-danger" type="submit" onclick="return confirm('Do you sure delete book (Emergency) ?')">Delete (Emergency)</button>
                    </form>
                </td>
            </tr>
        <?php } ?>
